...
public class ReportRestController {
	...
	public List<ReportItem> getReportDataByDatePeriod(@PathVariable("period") String period) {
		...
		switch (period) {
		case "last_7_days":
			return orderReportService.getReportDataLast7Days(ReportType.DAY);

		case "last_28_days":
			return orderReportService.getReportDataLast28Days(ReportType.DAY);
		case "last_6_months":
			return orderReportService.getReportDataLast6Months(ReportType.MONTH);	
		case "last_years":
			return orderReportService.getReportDataLast12Months(ReportType.MONTH);
		default:
			return orderReportService.getReportDataLast7Days(ReportType.DAY);
		}
	...
	public List<ReportItem> getReportDataByDatePeriod(@PathVariable("startDate") String startDate,
		...
		return orderReportService.getReportDataByDateRange(startTime, endTime,ReportType.DAY);
	}
